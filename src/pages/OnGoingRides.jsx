    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <div className='h-20 w-full bg-white flex items-center justify-between px-4 md:px-6 lg:px-8 shadow-sm'>
                ...
                <button className="flex items-center justify-center p-2 hover:bg-gray-100 rounded-full transition-colors" onClick={() => navigate('/home')}>
            ...
            <div className="flex-1 p-4 md:p-6">
                <div className="container mx-auto">
                    <h2 className="text-xl md:text-2xl font-semibold mb-4">Your Ongoing Rides</h2>
                    ...
                    {rides.length > 0 ? (
                        ...
                        <div className="text-center py-10 bg-white rounded-xl shadow p-8">
                            <i className="ri-route-line text-5xl text-gray-400 mb-3"></i>
